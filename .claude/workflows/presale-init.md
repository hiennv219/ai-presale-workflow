...
├── _source/
├── workspace/
│   └── proposal-template.md  ← customizable proposal structure
└── _delivery/
```

### Step 2: Copy proposal template

Copy `.agent/references/proposal-template-default.md` → `projects/YYYY-MM-DD-<project-name>/workspace/proposal-template.md`.

This file defines the proposal section structure. Users can customize it (add/remove/reorder sections) before running `/presale-run`.

### Step 3: Write client-input.md template
...
Structure:
  ...
  workspace/proposal-template.md ← customize proposal structure here
...
- `workspace/proposal-template.md` exists.
